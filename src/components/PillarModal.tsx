      ...
      >
        <div className="sticky top-0 bg-[#4B1D5C] border-b border-[#FDFBF7]/15 p-6 flex items-start justify-between">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center justify-center border border-[#FDFBF7]/15 bg-[#FDFBF7]/10 rounded-lg">
              <Icon size={24} strokeWidth={1.2} className="text-[#B09469]" />
            </div>
            <div>
          ...
          <button
            onClick={onClose}
            className="text-[#B09469] hover:text-[#FDFBF7] transition-colors"
          >
        ...
        <div className="p-8 space-y-10">
          <div className="space-y-4">
            <h3 className="text-sm uppercase tracking-[0.15em] text-[#B09469] font-medium">
              What We Measure
            </h3>
