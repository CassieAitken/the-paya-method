export const Icons = {
  ...
  PayaMethodLogo: ({ size = 120, className = "" }: { size?: number; className?: string }) => (
    <svg width={size} height={size} viewBox="0 0 120 140" fill="none" className={className}>
      ...
      <text x="60" y="115" fontFamily="system-ui, -apple-system, sans-serif" fontSize="13" fontWeight="600" textAnchor="middle" fill="#0A4682" letterSpacing="0.5">The Paya Method</text>
