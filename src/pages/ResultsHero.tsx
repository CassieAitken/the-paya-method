      ...
      <div className="relative w-52 h-52 sm:w-64 sm:h-64 lg:w-72 lg:h-72 mx-auto">
        <svg className="w-full h-full -rotate-90" viewBox="0 0 200 200">
          ...
          <circle
            ...
            stroke="#2A2421" strokeWidth="8" strokeLinecap="round"
      ...
      <div className="space-y-8 sm:space-y-20 lg:space-y-24">
        ...
        <div className="space-y-6 sm:space-y-10 pb-4">
          <div className="bg-white rounded-none shadow-none border border-[#E8E2D9] p-8 sm:p-12 text-center space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <div className="h-px w-16 bg-[#2A2421]/30 mx-auto"></div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <Icons.Check size={16} className="text-[#2A2421] flex-shrink-0 mt-1" />
                      ...
                      <div key={idx} className="bg-white border border-[#E8E2D9] p-4 space-y-2.5">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center gap-2.5">
                            <PhaseIcon size={14} strokeWidth={1.3} className="text-[#2A2421]" />
                            <div>
                        ...
                        <div className="w-full h-1.5 bg-stone-200/60 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-[#2A2421] rounded-full transition-all duration-700"
                ...
                <div className="bg-white border border-[#E8E2D9] overflow-hidden">
                  ...
                  <div className="p-4">
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#2A2421] flex items-center justify-center text-white font-mono text-[9px] font-medium mt-0.5">
                        1
                      </div>
        ...
        <div className="max-w-2xl mx-auto text-center space-y-6 sm:space-y-8 pt-8 sm:pt-12">
          <div className="bg-[#4B1D5C] rounded-none p-8 sm:p-12 shadow-none relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#2A2421]/5 to-transparent pointer-events-none" />
            <div className="relative z-10 space-y-6">
              ...
              <div className="pt-4 space-y-4">
                <button
                  onClick={onUnlock}
                  className="bg-[#2A2421] text-white px-10 sm:px-16 py-4 sm:py-5 text-[10px] uppercase tracking-[0.15em] sm:tracking-[0.15em] hover:bg-[#3A3330] hover:-translate-y-1 transition-all font-bold rounded-none inline-flex items-center gap-3 shadow-none"
                >
  ...
  return (
    <div className="space-y-8 sm:space-y-20 lg:space-y-24">
      ...
      <div className="space-y-6 sm:space-y-14 lg:space-y-16 pb-4 sm:pb-12">
        <div className="h-px w-24 bg-[#2A2421]/30 mx-auto"></div>
          ...
          <div className="space-y-14">
            <div className="p-6 sm:p-8 lg:p-10 bg-white border border-[#E8E2D9] rounded-none shadow-none space-y-7">
              ...
              <div className="w-full h-2 bg-stone-200/60 relative overflow-hidden rounded-full">
                <div
                  className="absolute top-0 left-0 h-full bg-[#2A2421] transition-all duration-1000 rounded-full"
