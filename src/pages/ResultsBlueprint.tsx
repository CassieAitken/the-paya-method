    ...
    <div className="space-y-12 sm:space-y-16 lg:space-y-20 border-t border-[#E8E2D9] pt-12 sm:pt-16 lg:pt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white border border-[#E8E2D9] p-6 sm:p-8 rounded-none shadow-none">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-[#2A2421]/10 border border-[#2A2421]/20 flex items-center justify-center">
              <Icons.TrendingUp size={18} className="text-[#2A2421]" />
            </div>
            <div>
              <span className="text-[10px] uppercase tracking-[0.15em] text-[#2A2421] font-medium block">Superpower</span>
          ...
          <div className="flex items-center gap-3 mb-3">
            <div className="flex-1 h-2 bg-stone-200/60 rounded-full overflow-hidden">
              <div className="h-full bg-[#2A2421] rounded-full" style={{ width: `${topPillar.score}%` }} />
            </div>
              ...
              >
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    <Icon size={18} strokeWidth={1.3} className="text-[#2A2421]" />
                ...
                <div className="w-full h-2 bg-stone-200/60 relative rounded-full overflow-hidden">
                  <div
                    className="absolute top-0 left-0 h-full bg-[#2A2421] transition-all duration-700 rounded-full"
                    style={{ width: `${score}%` }}
                  />
                </div>
      ...
      <div className="space-y-12 pt-12 border-t border-[#E8E2D9]">
        ...
        <div className="bg-white border border-[#E8E2D9] p-6 sm:p-8 lg:p-12 rounded-none shadow-none">
          ...
          {dogData.reflection && (
            <p className="text-[#5C534E] text-lg mb-8 border-l-2 border-[#2A2421]/30 pl-6 italic font-light leading-[1.8]">
              "{dogData.reflection}"
            </p>
          )}
      ...
      <div className="space-y-12 pt-12 border-t border-[#E8E2D9]">
        ...
        <div className="bg-white border border-[#E8E2D9] rounded-none shadow-none overflow-hidden">
          ...
          <div className="p-6 sm:p-8 lg:p-10 border-b border-[#E8E2D9]">
            <div className="flex items-center gap-3 mb-4">
              <Icons.FlaskConical size={16} className="text-[#2A2421]" strokeWidth={1.5} />
          ...
          <div className="p-6 sm:p-8 lg:p-10 border-b border-[#E8E2D9] bg-[#FDFBF7]/50">
            <div className="flex items-center gap-3 mb-4">
              <Icons.Heart size={16} className="text-[#2A2421]" strokeWidth={1.5} />
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-6">
              <Icons.ClipboardList size={16} className="text-[#2A2421]" strokeWidth={1.5} />
                ...
                <div key={i} className="space-y-5">
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="space-y-2">
                        <span className="text-[10px] uppercase tracking-[0.15em] text-[#2A2421] font-medium">Expected Outcome</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-[#E8E2D9]">
            {[
              ...
              <div key={block.day} className="p-6 sm:p-8">
                <h5 className="text-[10px] uppercase tracking-[0.15em] text-[#2A2421] font-bold mb-5">{block.day}</h5>
                <ul className="space-y-3">
                  {block.items.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#2A2421]/40 flex-shrink-0 mt-[7px]" />
            ...
            <div key={phase.timeframe} className={`bg-white border border-[#E8E2D9] p-6 sm:p-8 ${idx === 0 ? '' : 'border-t-0'}`}>
              ...
              <ul className="space-y-3 ml-14">
                {phase.markers.map((marker, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <Icons.Check size={14} className="text-[#2A2421] flex-shrink-0 mt-[3px]" strokeWidth={2} />
            ...
            <div key={i} className="space-y-6 border-b border-[#E8E2D9] pb-10 last:border-0 last:pb-0">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-2 bg-stone-200/60 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-[#2A2421] transition-all"
              ...
              <div className="space-y-3">
                {f.rituals.map((r: any, j: number) => {
                  ...
                  const frequencyDisplay: Record<string, { label: string; color: string }> = {
                    daily: { label: 'Always', color: 'bg-[#2A2421]' },
                    often: { label: 'Usually', color: 'bg-[#2A2421]/80' },
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
          ...
          <div className="flex-1 space-y-8 w-full">
            <div className="space-y-3">
              ...
              <button
                onClick={handleShare}
                className="w-full bg-[#2A2421] text-white px-8 py-4 text-[10px] uppercase tracking-[0.15em] hover:bg-[#3A3330] hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3 rounded-none font-bold shadow-none"
              >
                {shareCopied ? (
                  <>
                    <Icons.Check size={15} />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-[#E8E2D9] text-[#5C534E] px-6 py-4 text-[10px] uppercase tracking-[0.15em] hover:border-[#2A2421] hover:text-[#2A2421] transition-all rounded-none font-bold"
            >
              {auditShared ? (
                <>
                  <Icons.Check size={15} />
            ...
            <div className="flex items-start gap-3 bg-white border border-[#E8E2D9] rounded-none p-4 shadow-none">
              <Icons.Mail size={16} className="text-[#2A2421] flex-shrink-0 mt-0.5" />
