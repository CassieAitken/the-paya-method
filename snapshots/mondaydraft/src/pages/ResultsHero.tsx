...
export function ResultsHero({
  ...
  const openingText = isLegacy
    ? <>We sat with {Name}'s data — all <strong>81 markers</strong>, every pattern, every signal {pPoss} body is sending in this golden chapter. Some of this will confirm what you already feel in your bones. Some of it will move you. All of it is a map for honoring the time you have together.</>
    : isMaster
      ? <>We sat with {Name}'s data — all <strong>81 markers</strong>, every pattern, every signal {pPoss} body is still sending after a decade of life. Some of this will confirm what you already know in your gut. Some will earn a deeper respect for what ${pSubj}'ve maintained. All of it is actionable — and at this stage, every action carries more weight.</>
      : <>We sat with {Name}'s data — all <strong>81 markers</strong>, every pattern, every signal {pPoss} body is sending. Some of this will confirm what you already feel in your gut. Some of it will surprise you. All of it is actionable.</>;
    ...
    <div className="space-y-24">
      ...
      <div className="space-y-16 pb-12">
        ...
        <div className="max-w-3xl mx-auto text-left space-y-8">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl leading-[1.9] text-stone-800 font-light italic">
            {blueprintLine}
          </p>
        </div>
      ...
      <div className="space-y-20 border-t border-stone-200/30 pt-20">
        ...
        {/* PRE-PURCHASE: CLEAN CTA */}
        {!hasPaid && (
          <div className="space-y-12 pt-8">
            {/* Single locked directive hint */}
            <div className="relative max-w-2xl mx-auto">
              <div className="border border-stone-200/70 bg-white/60 backdrop-blur-md rounded-2xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)]">
                <div className="flex items-center gap-4 px-8 pt-7 pb-5 border-b border-stone-100">
                ...
                <div className="p-8 select-none" style={{ filter: 'blur(6px)' }}>
            ...
            <div className="max-w-2xl mx-auto text-center space-y-7">
              <h3 className="text-3xl lg:text-4xl font-serif text-stone-900 tracking-tight leading-[1.15]">
                {Name}'s Blueprint is Ready
              </h3>
              <p className="text-stone-600 text-base lg:text-lg font-light leading-[1.7] max-w-lg mx-auto">
                Full analysis. 30-day protocol. Every directive — waiting for you.
              </p>
