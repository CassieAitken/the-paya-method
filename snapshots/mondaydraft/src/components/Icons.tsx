export const Icons = {
  ...
  RefreshCcw: ({ size = 24, className = "", strokeWidth = 1.5 }: { size?: number; className?: string; strokeWidth?: number }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M1 4v6h6" /><path d="M23 20v-6h-6" /><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4-4.64 4.36A9 9 0 0 1 3.51 15" /></svg>
  ),
  ...
  PayaLabsLogo: ({ size = 120, className = "" }: { size?: number; className?: string }) => (
    <svg width={size} height={size} viewBox="0 0 120 140" fill="none" className={className}>
      ...
      <g>
        <path d="M40 50 Q55 40 70 50" stroke="#0f766e" strokeWidth="3" fill="none" strokeLinecap="round"/>
        <circle cx="50" cy="58" r="3" fill="#0f766e"/>
        <circle cx="70" cy="58" r="3" fill="#0f766e"/>
        <path d="M48 68 Q60 75 72 68" stroke="#0f766e" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
      </g>

      <g opacity="0.4">
        <path d="M48 85 L52 92 M60 85 L60 93 M72 85 L68 92" stroke="#0f766e" strokeWidth="1.5" strokeLinecap="round"/>
      </g>

      <text x="60" y="115" fontFamily="system-ui, -apple-system, sans-serif" fontSize="16" fontWeight="600" textAnchor="middle" fill="#0f766e" letterSpacing="0.5">PayaLabs</text>
      <text x="60" y="130" fontFamily="system-ui, -apple-system, sans-serif" fontSize="9" fontWeight="500" textAnchor="middle" fill="#0f766e" opacity="0.7" letterSpacing="1">VITALITY</text>
    </svg>
  ),
};
