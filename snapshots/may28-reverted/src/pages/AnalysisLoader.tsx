...
const phases: Phase[] = [
  ...
  },
  {
    ...
    body: (name) =>
      `We've completed ${name}'s analysis. Your personalized Vitality Blueprint is ready. Preparing your roadmap now\u2026`,
  },
];
    ...
    <div className="fixed inset-0 z-[100] bg-[#F5F0EB] flex items-center justify-center">
      ...
      <div className="relative w-full max-w-xl mx-auto px-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Icons.Leaf size={18} className="text-ink-soft" strokeWidth={1.5} />
          <span className="font-mono text-[9px] uppercase tracking-[0.4em] text-ink-soft font-medium">
            PayaLabs Bio-Audit
          </span>
        </div>

        <h1 className="font-serif text-4xl sm:text-5xl text-stone-900 tracking-tight leading-[1.1] mb-16">
          Biological Assessment in Progress.
        </h1>

        {/* Phase counter */}
        <p className="font-mono text-[9px] uppercase tracking-[0.4em] text-ink-muted mb-6 font-medium">
          {phaseCounter}
        </p>
        ...
        {/* Phase body */}
        <p
          className="text-ink text-base sm:text-lg leading-[1.85] font-light max-w-lg mb-16"
          style={{
            opacity: textOpacity,
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <span className="font-mono text-[8px] uppercase tracking-[0.35em] text-ink-muted font-medium">
