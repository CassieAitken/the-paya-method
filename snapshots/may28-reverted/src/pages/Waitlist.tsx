    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-stone-100 to-stone-50 flex items-center justify-center p-4 sm:p-6">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-6 sm:p-8 lg:p-10 mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-10">
            <div className="text-center p-4 bg-stone-50 rounded-xl">
              <Icons.Droplet className="w-6 h-6 text-ink-soft mx-auto mb-2" strokeWidth={1.5} />
              <p className="text-xs font-medium text-ink-soft">The Internal Battery</p>
            </div>
            <div className="text-center p-4 bg-stone-50 rounded-xl">
              <Icons.Moon className="w-6 h-6 text-ink-soft mx-auto mb-2" strokeWidth={1.5} />
              <p className="text-xs font-medium text-ink-soft">The Restorative Cycle</p>
            </div>
            <div className="text-center p-4 bg-stone-50 rounded-xl">
              <Icons.Wind className="w-6 h-6 text-ink-soft mx-auto mb-2" strokeWidth={1.5} />
              <p className="text-xs font-medium text-ink-soft">The Biological Shield</p>
            </div>
            <div className="text-center p-4 bg-stone-50 rounded-xl">
              <Icons.Users className="w-6 h-6 text-ink-soft mx-auto mb-2" strokeWidth={1.5} />
              <p className="text-xs font-medium text-ink-soft">The Pack Bond</p>
            </div>
            <div className="text-center p-4 bg-stone-50 rounded-xl">
              <Icons.Brain className="w-6 h-6 text-ink-soft mx-auto mb-2" strokeWidth={1.5} />
              <p className="text-xs font-medium text-ink-soft">Ancestral Cognition</p>
            </div>
            <div className="text-center p-4 bg-stone-50 rounded-xl">
              <Icons.Activity className="w-6 h-6 text-ink-soft mx-auto mb-2" strokeWidth={1.5} />
              <p className="text-xs font-medium text-ink-soft">Biomechanical Flow</p>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto">
            ...
            <p className="text-xs text-ink-soft text-center mt-6 italic">
        ...
        <div className="text-center">
          <button
            onClick={handleSkip}
            className="text-sm text-ink-soft hover:text-stone-900 transition-colors underline"
          >
            I have early access
          </button>
        </div>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="text-xs text-ink-muted hover:text-stone-800 transition-colors"
          >
