...
export function ResultsHero({
    ...
    return (
      <div className="relative w-52 h-52 sm:w-64 sm:h-64 lg:w-72 lg:h-72 mx-auto">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-5xl sm:text-6xl lg:text-7xl font-serif text-[#1A0B2E] font-light tracking-tight">{score}</span>
          <span className="text-base sm:text-lg font-serif text-[#4A4A4A]/50 -mt-1">/100</span>
          <span className="text-[9px] font-mono uppercase tracking-[0.3em] text-[#4A4A4A]/40 mt-2">Vitality Index</span>
        </div>
      </div>
    );
  };
    ...
    return (
      <div className="space-y-8 sm:space-y-20 lg:space-y-24">
        ...
        <div className="space-y-6 sm:space-y-10 pb-4">
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.025)] border border-stone-100 p-8 sm:p-12 text-center space-y-6">
            <p className="text-[9px] font-mono uppercase tracking-[0.35em] text-[#4A4A4A]/50 font-medium">
            ...
            <div className="space-y-3 pt-2">
              ...
              <h3 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-[#1A0B2E] tracking-tight leading-[0.96]">
        ...
        {results.archetype.freeTeaser && (() => {
          ...
          return (
            <div className="max-w-2xl mx-auto relative">
              <p className="text-lg sm:text-xl leading-[1.9] text-[#4A4A4A] font-light">
                {firstSentence}
              </p>
              {remaining && (
              ...
              <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-[#4A4A4A]/40 mt-4 text-center">
        ...
        {/* 3. Three Phase progress bars */}
        {directives && (
          <div className="max-w-3xl mx-auto space-y-6 border-t border-stone-200/40 pt-8 sm:pt-16">
            <h4 className="text-2xl sm:text-3xl font-serif text-[#1A0B2E] tracking-tight leading-tight">
              {Name}'s Vitality Phases
            </h4>
            <div className="space-y-4">
              {[
                ...
                return (
                  <div key={idx} className="bg-white border border-stone-100 rounded-2xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.025)] space-y-3">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        <PhaseIcon size={16} strokeWidth={1.3} className="text-[#415A42]" />
                        <div>
                          <span className="font-mono text-[8.5px] uppercase tracking-[0.3em] font-medium text-[#2A2421] block">
                            Phase {idx + 1}: {phase.label}
                          </span>
                          <span className="text-[10px] text-[#4A4A4A]/50 font-light">{phase.desc}</span>
                        </div>
                      </div>
                      <span className="text-[#2A2421] text-lg font-serif font-light">{phaseScore}%</span>
                    </div>
        ...
        {/* 4. One protocol step free preview */}
        {directives && (
          <div className="max-w-3xl mx-auto space-y-6 border-t border-stone-200/40 pt-8 sm:pt-16">
            <h4 className="text-2xl sm:text-3xl font-serif text-[#1A0B2E] tracking-tight leading-tight">
              Your Priority Protocol — Preview
            </h4>
            <div className="bg-white border border-stone-100 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.025)] overflow-hidden">
              <div className="bg-[#1A0B2E] text-white p-5 sm:p-6">
                <div className="flex items-center gap-3">
                  <span className="text-xl">{directives.priorityShift.emoji}</span>
                  <div>
                    ...
                    <span className="text-sm font-light text-white/90">{directives.priorityShift.protocolTitle}</span>
                  </div>
                </div>
              </div>
              <div className="p-5 sm:p-7">
                <div className="flex gap-3">
                  <div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#14B8A6] flex items-center justify-center text-white font-mono text-[10px] font-medium mt-0.5">
                    1
                  </div>
                  <p className="text-sm text-[#4A4A4A] leading-[1.8] font-light pt-0.5">
        ...
        {/* 5. What unlocks checklist */}
        <div className="max-w-2xl mx-auto space-y-5 sm:space-y-8 border-t border-stone-200/40 pt-8 sm:pt-16">
          <p className="text-[#4A4A4A] text-base sm:text-lg font-medium leading-[1.85]">
          ...
          <ul className="space-y-3">
            {[
              ...
              <><strong>Priority-ordered 30-day protocol</strong> — start with what moves the needle most</>,
              ...
              <li key={i} className="flex items-start gap-3">
                ...
                <span className="text-base text-[#4A4A4A] leading-[1.7]">{item}</span>
              </li>
            ))}
          </ul>
          <p className="text-[#4A4A4A]/60 text-sm font-light leading-[1.8] italic">
        ...
        <div className="max-w-2xl mx-auto text-center space-y-6 sm:space-y-8 pt-8 sm:pt-12">
          <div className="bg-[#1A0B2E] rounded-3xl p-8 sm:p-12 shadow-[0_20px_60px_-12px_rgba(26,11,46,0.3)] relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-white text-lg sm:text-xl font-light leading-[1.85] max-w-xl mx-auto">
                You spent 10 minutes learning how to love them better. Spend $29 to know exactly how.
              </p>
              ...
              <div className="pt-4 space-y-4">
                <button
                  onClick={onUnlock}
                  className="bg-[#14B8A6] text-white px-10 sm:px-16 py-4 sm:py-5 text-[10px] font-mono uppercase tracking-[0.25em] sm:tracking-[0.3em] hover:bg-[#0D9488] hover:-translate-y-1 transition-all font-bold rounded-xl inline-flex items-center gap-3 shadow-lg shadow-[#14B8A6]/20"
                >
                  <span>UNLOCK {Name.toUpperCase()}'S BLUEPRINT — $29</span>
  ...
  const blueprintLine = isLegacy
    ...
    : isMaster
      ...
      : <>What follows is {Name}'s <strong>Vitality Blueprint</strong> — your roadmap to unlocking what's next.</>;
    ...
    <div className="space-y-8 sm:space-y-20 lg:space-y-24">
      ...
      <div className="space-y-6 sm:space-y-14 lg:space-y-16 pb-4 sm:pb-12">
        ...
        <div className="max-w-3xl mx-auto text-left space-y-8">
          <p className="text-[9px] font-mono uppercase tracking-[0.35em] text-[#4A4A4A]/60 font-medium">
            Prepared for {dogData.ownerName || 'you'} & {name} — {trackLabel} Track
          </p>
          <p className="text-lg sm:text-xl lg:text-2xl leading-[1.9] text-[#4A4A4A] font-light">
            {openingText}
          </p>
          <p className="text-lg sm:text-xl lg:text-2xl leading-[1.9] text-[#1A0B2E]/80 font-light italic">
            {blueprintLine}
          </p>
        </div>
        ...
        {/* ARCHETYPE REVEAL */}
        <h2 className="text-center text-6xl sm:text-7xl lg:text-8xl xl:text-9xl font-serif text-[#1A0B2E] tracking-tight leading-[0.92]">
          {results.archetype.name}
        </h2>

        <div className="max-w-3xl mx-auto space-y-8 text-center">
          <p className="text-[#4A4A4A] text-lg sm:text-xl lg:text-2xl leading-[1.8] font-light">
      ...
      <div className="space-y-12 sm:space-y-16 lg:space-y-20 border-t border-stone-200/40 pt-12 sm:pt-16 lg:pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
          ...
          <div className="text-center space-y-10">
            <RadialScore score={results.score} />
            <div className="inline-block bg-[#1A0B2E] text-white text-[8px] font-mono uppercase tracking-[0.3em] px-4 py-1.5 rounded-full shadow-md">
              Founding Member
            </div>
            <div className="space-y-3 text-left max-w-md mx-auto">
              <p className="text-sm leading-[1.8] text-[#4A4A4A] font-light" dangerouslySetInnerHTML={{ __html: scoreNarrative[scoreTier] }} />
            </div>
          </div>

          {/* Human-Dog Sync */}
          <div className="space-y-14">
            <div className="p-6 sm:p-8 lg:p-10 bg-white border border-stone-100 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.025)] space-y-7">
              <div className="flex items-center justify-between">
                <span className="font-mono text-[8.5px] uppercase tracking-[0.35em] text-[#4A4A4A]/60 font-medium">
                  Human-Dog Sync
                </span>
                <span className="text-[#1A0B2E] text-2xl font-serif font-light">
                  {results.packSync}%
                </span>
              </div>
              ...
              <p className="text-sm leading-[1.8] text-[#4A4A4A] font-light" dangerouslySetInnerHTML={{ __html: syncNarrative }} />
            </div>
          </div>
        </div>
      </div>
