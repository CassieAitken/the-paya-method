      ...
      >
        <div className="sticky top-0 bg-white border-b border-stone-200/50 p-6 flex items-start justify-between">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 flex items-center justify-center border border-stone-200/50 bg-stone-50 rounded-lg">
              <Icon size={24} strokeWidth={1.2} className="text-ink-soft" />
            </div>
            <div>
              <h2 className="text-2xl font-serif text-stone-900">{pillar.title}</h2>
              <p className="text-sm text-ink-faint mt-1">The Seven Pillars of Vitality</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-8 space-y-10">
          <div className="space-y-4">
            <h3 className="text-sm font-mono uppercase tracking-[0.35em] text-ink-muted font-medium">
              What We Measure
            </h3>
            <p className="text-lg leading-[1.8] text-ink font-light">
              {pillar.guidance}
            </p>
          </div>
          ...
          <div className="border-t border-stone-200/50 pt-8 space-y-4">
            ...
            <p className="text-lg leading-[1.8] text-ink-soft font-light">
              {pillar.insight}
            </p>
          </div>
          ...
          <div className="border-t border-stone-200/50 pt-8 space-y-4">
            ...
            <p className="text-base leading-[1.8] text-ink-soft font-light">
              {pillar.endpointDesc}
            </p>
          </div>
        </div>
