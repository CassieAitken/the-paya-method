        ...
        <div className="bg-gradient-to-b from-stone-50 to-white p-8 lg:p-12 space-y-8">
          <div className="flex items-start justify-between">
            <div className="space-y-2">
              <span className="text-sm font-mono text-ink-muted uppercase tracking-wider">Day {dayNumber} Check-In</span>
              <h3 className="text-4xl lg:text-5xl font-serif text-stone-900 leading-tight">
                How's {dogName} doing?
              </h3>
              <p className="text-ink-muted text-lg mt-4 font-light">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <label className="block">
                <span className="font-mono text-[8px] uppercase tracking-[0.35em] text-ink-soft font-medium">
                  Energy Level
                </span>
                <p className="text-ink-muted text-sm mt-1 font-light">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full bg-stone-50 border border-stone-200 rounded-lg p-4 text-sm text-ink placeholder:text-ink-faint focus:outline-none focus:ring-2 focus:ring-stone-900 focus:border-transparent font-light"
                rows={5}
              />
            </div>
          </div>
          ...
          <div className="flex gap-4 pt-4">
            <button
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 border-2 border-stone-300 text-ink-soft py-4 rounded-lg font-mono text-[11px] tracking-widest font-bold hover:bg-stone-50 transition-colors disabled:opacity-50"
            >
              CANCEL
            </button>
            <button
