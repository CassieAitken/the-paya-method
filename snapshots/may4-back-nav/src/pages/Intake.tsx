...
export function Intake({
  ...
  return (
    <div className="w-full">
        ...
        <div className="bg-gradient-to-b from-stone-50 to-white border-b border-stone-200/50 py-16">
          <div className="max-w-5xl mx-auto px-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-4 p-4 sm:p-5 bg-white border border-stone-200/70 rounded-lg hover:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] transition-shadow">
      ...
      <div className="py-20 sm:py-40 space-y-16 sm:space-y-28 max-w-5xl mx-auto px-6">
      <div className="space-y-9">
        <div className="editorial-divider max-w-sm"></div>
        <h2 className="text-4xl sm:text-5xl lg:text-7xl font-serif text-stone-900 tracking-tight leading-[1.05]">Tell Us About Your Companion</h2>
      </div>
      <div className="space-y-16 sm:space-y-32">
        <div className="space-y-8">
          ...
          <input
            className="w-full bg-transparent border-b-2 border-stone-300 pb-4 sm:pb-6 outline-none font-serif text-3xl sm:text-4xl text-stone-900 focus:border-stone-700 transition-colors placeholder:text-stone-300 font-light"
            ...
            {dogPhoto ? (
              <div className="relative group">
                <img
                  src={dogPhoto}
                  alt="Dog"
                  className="w-24 h-24 rounded-full object-cover border-2 border-stone-200 shadow-md"
                />
                <button
              ...
              <div className="w-24 h-24 rounded-full border-2 border-dashed border-stone-300 flex items-center justify-center bg-stone-50">
                <Icons.Camera size={24} className="text-stone-400" strokeWidth={1.5} />
              </div>
            )}
            <button
              type="button"
              onClick={() => fileInputRef.current?.click()}
              className="text-[8.5px] font-mono uppercase tracking-[0.3em] text-stone-700 border border-stone-300 px-5 py-3 rounded-lg hover:bg-stone-50 hover:border-stone-400 transition-all font-medium"
            >
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            />
            <p className="text-[8px] text-stone-500 font-mono uppercase tracking-[0.32em] font-medium">If you know it, great. If not, leave blank.</p>
          </div>
        </div>
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 border border-stone-200/70 overflow-hidden bg-white/50 rounded-lg">
            {DOG_SIZES.map((size) => (
              <button
                key={size}
                onClick={() => setDogData({ ...dogData, size })}
                className={`py-5 sm:py-6 px-3 text-[8.5px] font-mono uppercase tracking-[0.25em] transition-all border-r last:border-r-0 border-b sm:border-b-0 border-stone-200/70 font-medium ${
      ...
      <div className="flex justify-between items-center pt-12 sm:pt-24 border-t border-stone-200/30">
        {import.meta.env.DEV && (
          <button
            onClick={() => {
