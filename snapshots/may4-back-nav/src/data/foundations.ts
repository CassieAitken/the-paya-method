...
export const foundations: any[] = [
  ...
  },
  {
    ...
    rituals: [
      ...
      { id: 's3', label: 'Co-Sleeping', weight: 1.0, desc: (name: string) => `${name} sleeps in bed with you or curled up with another dog in the household -- sharing warmth and contact through the night.` },
  ...
  },
  {
    ...
    rituals: [
      ...
      { id: 'e9', label: 'Low Blue Light Environment', weight: 1.3, desc: (name: string) => `${name}'s home minimizes artificial blue light -- warm-toned bulbs, screens dimmed or off, and no harsh overhead LEDs flooding their space -- protecting their eyes, hormones, and sleep cycle.` },
  ...
  },
  {
    ...
    rituals: [
      ...
      { id: 'bf7', label: 'Comfortable with Stairs & Jumps', weight: 1.4, desc: (name: string) => `${name} handles stairs and getting on or off furniture with confidence appropriate for their age -- no unexpected hesitation, stutter-stepping, or signs of discomfort.`, legacySignal: true },
