  ...
  return (
    <div className="animate-in-slow">
      ...
      <div className="flex flex-col items-center text-center py-20 lg:py-36 min-h-[90vh] justify-center space-y-14">
        ...
        <div className="max-w-xl space-y-6">
          <p className="font-mono text-[10px] sm:text-[11px] uppercase tracking-[0.3em] text-stone-400 leading-[2.4]">
            90 Biological Markers&ensp;&middot;&ensp;7 Vitality Pillars&ensp;&middot;&ensp;One Blueprint
          </p>
          <p className="text-stone-500 text-lg lg:text-xl leading-[1.8] font-light tracking-tight">
            One personalized blueprint to unlock deeper energy, emotional fluency, and the vibrant spark at the heart of your bond.
          </p>
        </div>
        <button
          onClick={() => {
      ...
      <div className="text-center pb-24 lg:pb-32 px-8 space-y-10 max-w-5xl mx-auto" data-section="framework">
        ...
        <p className="text-stone-600 text-lg lg:text-xl max-w-3xl mx-auto leading-[1.75] font-light">
          We map the biological systems your dog depends on every day — from first stretch to last sigh. Each pillar reveals where vitality flows freely and where it's waiting to be unlocked.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="md:col-span-2 bg-stone-900 text-white py-16 px-12 lg:px-16 space-y-9 rounded-xl">
          <div className="flex items-start gap-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-stone-400 text-xs font-mono tracking-[0.3em] uppercase">90 Biological Markers</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="space-y-4 pl-7">
              ...
              <p className="text-base leading-[1.75] text-stone-300 font-light">
                We distilled decades of vitality research into <strong>90 markers</strong> that map where your dog thrives — and where small shifts unlock the biggest gains.
              </p>
            </div>
          </div>
        </div>
