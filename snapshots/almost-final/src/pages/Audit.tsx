...
export function Audit({
  ...
  return (
    <div className="min-h-screen py-24 animate-in-slow px-6 relative">
      {/* Dog Photo Tracker */}
      <div className="fixed top-28 right-6 z-40">
        {dogPhoto ? (
          ...
          <div className="w-12 h-12 rounded-full border-2 border-white shadow-lg bg-stone-100 flex items-center justify-center">
