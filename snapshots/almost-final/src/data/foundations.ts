...
export const foundations: any[] = [
  ...
  },
  {
    ...
    rituals: [
      { id: 'bf0', label: 'Daily Exercise', weight: 2.0, desc: (name: string) => `${name} gets meaningful physical exercise every day -- a real walk, a run, active play, or swimming -- enough to leave them pleasantly tired.` },
