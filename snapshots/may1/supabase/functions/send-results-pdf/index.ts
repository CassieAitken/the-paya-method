...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "PayaLabs <onboarding@resend.dev>",
    ...
    <div class="directive">
      <div style="display: flex; align-items: start; gap: 15px;">
        ...
        <div style="flex: 1;">
          ...
          <p style="color: #57534e; margin: 0 0 15px;">${d.desc}</p>
          <div style="background: #f5f5f4; padding: 15px; border-left: 2px solid #78716c;">
            <p style="font-size: 11px; text-transform: uppercase; letter-spacing: 1.5px; color: #78716c; margin: 0 0 5px;">
              The Vitality Opportunity
            </p>
            <p style="color: #292524; font-size: 14px; margin: 0;">
              ${d.implementation}
            </p>
          </div>
        </div>
