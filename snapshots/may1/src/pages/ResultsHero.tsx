      ...
      <div className="space-y-20 border-t border-stone-200/30 pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-28 items-center">
          ...
          <div className="text-center space-y-14">
            <div className="w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 bg-white border border-stone-200/70 mx-auto flex flex-col items-center justify-center relative shadow-[0_40px_100px_-25px_rgba(0,0,0,0.15)]">
              ...
              <span className="text-[10px] font-mono uppercase tracking-[0.35em] text-stone-600 mt-6 block">
                Vitality Index
              </span>
            </div>
        ...
        {!hasPaid && (
          <div className="relative">
            <div className="max-w-3xl mx-auto text-center space-y-10 py-16 border border-stone-200/70 bg-white/80 backdrop-blur-md rounded-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)]">
              <div className="space-y-4">
                <Icons.Lock size={28} className="mx-auto text-stone-400" strokeWidth={1.5} />
                <h3 className="text-3xl lg:text-4xl font-serif text-stone-900 tracking-tight leading-[1.08]">
                  The Full Blueprint Awaits
                </h3>
                <p className="text-stone-600 text-base lg:text-lg leading-[1.8] font-light max-w-xl mx-auto">
                  We mapped all <strong>seven pillars</strong>, identified your top corrective directives, and built {Name}'s personalized <strong>30-day protocol</strong>. The roadmap is ready. Unlock it to see exactly where to start.
                </p>
              </div>
              <div className="space-y-4">
                <button
                  onClick={onUnlock}
                  className="bg-stone-900 text-white px-16 py-6 text-[9px] font-mono uppercase tracking-[0.35em] hover:bg-stone-800 hover:-translate-y-1 hover:shadow-[0_25px_60px_-10px_rgba(0,0,0,0.2)] transition-all font-medium rounded-lg inline-flex items-center gap-3"
                >
