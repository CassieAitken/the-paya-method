...
const phases: Phase[] = [
  {
    ...
    body: (name) =>
      `We're cross-referencing ${name}'s 90 longevity markers against the vitality curve for their life stage. Every answer you gave is shaping a profile unique to ${name}'s biology.`,
  },
  {
  ...
  },
  {
    ...
    body: (name) =>
      `Our Specialist has completed ${name}'s analysis. Your personalized Vitality Blueprint is ready. Preparing your roadmap now\u2026`,
  },
];
    ...
    <div className="fixed inset-0 z-[100] bg-[#F5F0EB] flex items-center justify-center">
      ...
      <div className="relative w-full max-w-xl mx-auto px-8">
        ...
        <div className="flex items-center gap-3 mb-20">
          <Icons.Leaf size={18} className="text-stone-500" strokeWidth={1.5} />
          <span className="font-mono text-[9px] uppercase tracking-[0.4em] text-stone-500 font-medium">
            PayaLabs Bio-Audit
          </span>
        </div>

        {/* Phase counter */}
        <p className="font-mono text-[9px] uppercase tracking-[0.4em] text-stone-400 mb-6 font-medium">
          {phaseCounter}
        </p>

        {/* Phase label */}
        <h2
          className="font-serif text-3xl sm:text-4xl text-stone-900 tracking-tight leading-[1.15] mb-8"
          style={{
            opacity: textOpacity,
        ...
        {/* Phase body */}
        <p
          className="text-stone-600 text-base sm:text-lg leading-[1.85] font-light max-w-lg mb-16"
          style={{
            opacity: textOpacity,
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <span className="font-mono text-[8px] uppercase tracking-[0.35em] text-stone-400 font-medium">
