        ...
        {(isLegacy || isMaster) && (
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 border border-[#E8E2D9] bg-white">
              ...
              <span className="text-[9px] font-mono uppercase tracking-[0.35em] text-[#5C534E] font-medium">
          ...
          <div className="max-w-xl mx-auto space-y-6">
            {hasPaid && selectedProduct === 'complete_vitality_system' && (
              <div className="text-left bg-white border border-[#E8E2D9] p-6 sm:p-8 rounded-none shadow-none space-y-3">
                <p className="font-mono text-[9px] uppercase tracking-widest text-[#5C534E]/60">You're in. Here's what happens next:</p>
                <p className="text-[#5C534E] font-light leading-[1.9]">Your Blueprint is on its way — check your inbox now.</p>
                <p className="text-[#5C534E] font-light leading-[1.9]">Watch for a second email tomorrow — it contains your 30-Day Protocol guide.</p>
                <p className="text-[#5C534E] font-light leading-[1.9]">Both are yours. Take them at your own pace.</p>
              </div>
            )}
            {hasPaid && selectedProduct === 'blueprint_in_motion' && (
              <div className="text-left bg-white border border-[#E8E2D9] p-6 sm:p-8 rounded-none shadow-none space-y-3">
                <p className="text-[#5C534E] font-light leading-[1.9]">You're in. Your 30-Day Protocol guide arrives in your inbox tomorrow.</p>
                <p className="text-[#5C534E]/70 font-light leading-[1.8]">Want to know exactly which of the 30 days matter most for your dog specifically? Your personal Vitality Blueprint takes just 10 minutes.</p>
              </div>
            )}
            {hasPaid && selectedProduct === 'vitality_blueprint' && (
              <div className="text-left bg-white border border-[#E8E2D9] p-6 sm:p-8 rounded-none shadow-none space-y-3">
                ...
                <p className="text-[#5C534E]/70 font-light leading-[1.8]">Want to activate your Blueprint faster? Add The 30-Day Protocol — your 30-day action guide — for just $19.</p>
              </div>
            )}
            {!hasPaid && (
