  ...
  if (!hasPaid) {
    return (
      <div className="space-y-8 sm:space-y-20 lg:space-y-24">
        ...
        {directives && (
          <div className="max-w-3xl mx-auto space-y-6 border-t border-[#E8E2D9] pt-8 sm:pt-16">
            <h4 className="text-2xl sm:text-3xl font-serif text-[#2A2421] tracking-tight leading-tight">
            ...
            <div className="space-y-4">
              {[
                ...
                return (
                  <div key={idx} className="bg-white border border-[#E8E2D9] rounded-none p-5 shadow-none space-y-3">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-[#5C534E]/50 font-light">{phase.desc}</span>
                        </div>
                      </div>
        ...
        {directives && (
          <div className="max-w-3xl mx-auto space-y-6 border-t border-[#E8E2D9] pt-8 sm:pt-16">
            ...
            <div className="bg-white border border-[#E8E2D9] rounded-none shadow-none overflow-hidden">
              <div className="bg-[#2A2421] text-white p-5 sm:p-6">
                <div className="flex items-center gap-3">
              ...
              <div className="p-5 sm:p-7">
                <div className="flex gap-3">
                  ...
                  <p className="text-sm text-[#5C534E] leading-[1.8] font-light pt-0.5">
        ...
        <div className="max-w-2xl mx-auto space-y-5 sm:space-y-8 border-t border-[#E8E2D9] pt-8 sm:pt-16">
          ...
          <p className="text-[#5C534E]/60 text-sm font-light leading-[1.8] italic">
