...
export function ResultsBlueprint({
  ...
  return (
    <div className="space-y-12 sm:space-y-16 lg:space-y-20 border-t border-[#E8E2D9] pt-12 sm:pt-16 lg:pt-20">
      {/* ===== BLUEPRINT HEADER ===== */}
      <div>
        <h2 className="text-2xl font-serif text-[#2A2421] leading-tight">{Name}'s Vitality Blueprint</h2>
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 flex-shrink-0">
            ...
            <div className="mt-6 space-y-3">
              <button
                ...
                className="w-full bg-[#14B8A6] text-white px-8 py-4 text-[8.5px] font-mono uppercase tracking-[0.35em] hover:bg-[#0D9488] hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3 rounded-none font-bold shadow-none disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isExportingBadge ? (
                  <>
              ...
              <button
                ...
                disabled={isExportingBadge}
                className="w-full flex items-center justify-center gap-3 border border-[#E8E2D9] text-[#5C534E] px-6 py-3.5 text-[8.5px] font-mono uppercase tracking-[0.3em] hover:border-[#14B8A6] hover:text-[#14B8A6] transition-all rounded-none font-bold disabled:opacity-50 disabled:cursor-not-allowed"
              >
