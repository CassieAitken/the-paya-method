    ...
    <div className="space-y-8 pt-12 sm:pt-16 border-t border-stone-200/40">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          ...
          <button
            onClick={handleShare}
            className="flex items-center justify-center gap-2 px-8 py-3 border-2 border-[#2A2421] text-[#2A2421] text-[9px] font-mono uppercase tracking-[0.25em] rounded-xl hover:bg-[#2A2421] hover:text-white transition-all"
          >
