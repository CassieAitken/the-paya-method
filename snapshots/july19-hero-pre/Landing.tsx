    ...
    <div className="animate-in-slow bg-[#FDFBF7]">
      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-center text-center px-6 sm:px-8 py-20 md:py-32">
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 hero-stagger">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[10px] sm:text-[11px] font-mono uppercase tracking-[0.25em] text-[#8A7F72]">
            <span>10-Minute Assessment</span>
            <span className="w-1 h-1 rounded-full bg-[#415A42]/30" />
          ...
          <div className="flex flex-col items-center justify-center gap-3 w-full max-w-sm mx-auto">
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[13px] sm:text-[14px] font-serif italic text-[#415A42] underline underline-offset-4 decoration-[#415A42]/40 hover:decoration-[#415A42] transition-colors cursor-pointer"
            >
              See what you get
              <Icons.ChevronDown size={13} strokeWidth={1.5} className="text-[#415A42]/70" />
            </button>
            <button
              type="button"
              onClick={() => {
