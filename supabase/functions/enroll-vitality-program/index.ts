...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Create program enrollment for guide and bundle buyers
    const programTiers = ['blueprint_in_motion', 'complete_vitality_system', 'program'];
    if (programTiers.includes(payload.tier)) {
      const now = new Date();
    ...
    return new Response(
      JSON.stringify({
        ...
        dogNumber: assessment.dog_number,
        tier: payload.tier,
